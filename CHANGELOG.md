## [3.3.20](https://github.com/device-management-toolkit/ui-toolkit/compare/v3.3.19...v3.3.20) (2026-08-26)
...
- **deps-dev:** bump [@types](https://github.com/types)/node from 20.11.19 to 20.11.21 ([#915](https://github.com/open-amt-cloud-toolkit/ui-toolkit/issues/915)) (#3f015b1)
...
- **deps:** bump codecov/codecov-action from 3.1.4 to 3.1.5 ([#877](https://github.com/open-amt-cloud-toolkit/ui-toolkit/issues/877)) (#a82aebb)
...
- **deps-dev:** bump eslint from 8.55.0 to 8.56.0 ([#838](https://github.com/open-amt-cloud-toolkit/ui-toolkit/issues/838)) (#ec96081)
...
- **deps-dev:** bump [@types](https://github.com/types)/node from 20.4.4 to 20.4.5 ([#679](https://github.com/open-amt-cloud-toolkit/ui-toolkit/issues/679)) (#daeca37)
...
- **deps-dev:** bump eslint from 8.41.0 to 8.42.0 ([#632](https://github.com/open-amt-cloud-toolkit/ui-toolkit/issues/632)) (#90fb906)
...
- **deps-dev:** bump webpack from 5.76.2 to 5.76.3 ([#588](https://github.com/open-amt-cloud-toolkit/ui-toolkit/issues/588)) (#34609fe)
...
- **deps-dev:** bump ts-loader from 9.2.3 to 9.2.5 (#68938fc)
...
- **deps-dev:** bump [@types](https://github.com/types)/ws from 7.4.4 to 7.4.5 ([#226](https://github.com/open-amt-cloud-toolkit/ui-toolkit/issues/226)) (#f4f37dd)
...
- **deps-dev:** bump webpack from 5.35.0 to 5.35.1 (#5de6b53)
...
- update to include coverage (#892c5cd)
- sync dependencies (#c7786ec)
- add simple build for ui-toolkit (#47739ac)

### Docs

- add changelog (#a62ef33)
- add status badges (#bb6a23b)
- add release disclaimer (#211510c)

### Feat

- add cors support (#fd7f988)
- hide MEBx password related fields for client control mode in profile control (#082f634)

### Fix

- upgrade ws from 7.2.0 to 7.3.1 (#40c2e15)
- **ciraconfig:** root cert now uses mps server address (#5c9d010)
- **ciraconfig:** mps root cert autoload (#305f7fe)
- **ciraconfig:** mps root cert autoload (#6fc9d7e)
- **ciraconfigform:** changed mpsServer prop mandatory (#0ea751a)
- **ciraconfigform:** resloved review comments (#5b01ff1)
- **circonfigform:** mps cert load (#badeb03)
- **tests:** Fix timezone issue in timerenderer unit test (#943df3e)
- **tests:** memory leak in tests (#a765cf8)

### Refactor

- **deps:** remove recompose (#b3198e4)

### Test

- Add more unit tests to have better code coverage (#696e7d6)
- uncomment unit tests (#0653cca)

### Tests

- disable image related tests for coverage (#e92f826)
...
[v1.2.0]: https://github.com/open-amt-cloud-toolkit/ui-toolkit/compare/v1.1.0...v1.2.0
[v1.1.0]: https://github.com/open-amt-cloud-toolkit/ui-toolkit/compare/v1.0.0...v1.1.0
