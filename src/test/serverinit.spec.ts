...
describe('Test processState function in ServerInit', () => {
  it('Test processState with positive test case: acc length greater than 24 + count value (at bytes20-23)', () => {
    expect.assertions(2)
    // create objects
  ...
  it('Test processState with positive test case: acc length equal to that of 24 + count value at bytes20-23 value', () => {
    expect.assertions(2)
    // create objects
    const communicator = new Communicator()
    const serverinit = new ServerInit(communicator, new AmtDesktop(), (state) => {
  ...
  it('Test processState with positive test case: acc length is equal to 24 and count value at bytes20-23 value is 0', () => {
    expect.assertions(2)
    // create objects
    const communicator = new Communicator()
    const serverinit = new ServerInit(communicator, new AmtDesktop(), (state) => {
